...
L["Flash Warning Rows Red"] = true
L["If checked, items with vendor price warnings will flash red in the log during post scans."] = true
...
L["Stack Size:"] = true
L["Num Stacks:"] = true
L["Bid (per stack):"] = true
L["Buyout (per stack):"] = true
L["Confirm Post"] = true
